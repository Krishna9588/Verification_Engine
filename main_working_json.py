...
JSON_CHECKPOINT_FILE = f"checkpoint_json/{csv_name}_checkpoint_json.json"
...
def load_processed_items():
    """
    Loads already processed (URL, Keyword) pairs from checkpoints.
    Prioritizes the CSV file and uses the JSON file as a backup.
    """
